"""
Django settings for AutoDashProject project.
...
SECRET_KEY = 'django-insecure-uypwkd%dz@=)m_!a7c6&kjb!jt%d0_q-nd8jp6y7k@6mu*6$@+'
...
MIDDLEWARE = [
    ...
    # Adding additional MIDDLEWARE for DASH
	'django_plotly_dash.middleware.BaseMiddleware',
]

ROOT_URLCONF = 'AutoDashProject.urls'
...
WSGI_APPLICATION = 'AutoDashProject.wsgi.application'
